...
The rebuild process runs automatically when dirty segments need to be written to storage. 
If necessary, you can manually trigger a rebuild through the Actions tab, though this is rarely required and mainly used for technical support.
