...
After submitting a query in xref:https://docs.tigergraph.com/gsql-ref/current/querying/query-operations#_detached_mode_async_option[Detached Mode] using the `GSQL-ASYNC` header, you can use the Query Status API to monitor the query by its `requestid`.
