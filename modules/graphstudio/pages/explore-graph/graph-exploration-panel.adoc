...
image::graph-explore-revised.png[Explorer View Menu]
...
When you choose to Export PNG, your browser will automatically download a picture named `export.png`. You can also use this option to save a screenshot of the current exploration result. 
