...
[NOTE]
====
This `ExportedGraph.zip` file is identical to what is produced by running the xref:tigergraph-server:backup-and-restore:database-import-export.adoc[database export command] with the template option.
====
