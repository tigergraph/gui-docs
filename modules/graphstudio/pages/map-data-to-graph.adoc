...
You also have the option to add an alias to the data source connection.
...
+
--
TigerGraph creates a connection to ABS in order to access the file system in a blob.
Only one file may be selected at a time.
...
. After you click the btn:[ABS] data source icon, you will be prompted for your Connection String.
. Add an alias to the data source connection.
