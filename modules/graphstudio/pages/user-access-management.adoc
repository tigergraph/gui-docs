...
GraphStudio follows the TigerGraph user authentication and role-based access control model as described in the document xref:{page-component-version}@tigergraph-server:user-access:index.adoc[].
...
See the xref:{page-component-version}@tigergraph-server:user-access:index.adoc[] guide for information on setting up LDAP or SSO.
...
The TigerGraph system can support multiple graphs within one TigerGraph instance. Read more at xref:{page-component-version}@tigergraph-server:intro:multigraph-overview.adoc[MultiGraph - An Overview].
