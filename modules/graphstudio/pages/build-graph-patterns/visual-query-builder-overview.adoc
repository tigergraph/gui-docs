...
Currently, Visual Query Builder is still in beta. Please expect lots of improvements and changes coming in the future!
...
The working panel is the central component (both visually and logically) of the Visual Query Builder. Your visual patterns are rendered here.
