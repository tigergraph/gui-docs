...
== Give an alias and Print in customized name

You can give any vertex, edge, and pattern view an alias and GSQL will have "AS your alias" attached and result will be displayed in this alias.
