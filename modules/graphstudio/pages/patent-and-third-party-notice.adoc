...
:description: list of GraphStudio patents and 3rd party components
...
WARNING: TigerGraph’s license to use and distribute the ZoomCharts visualization library embedded within certain versions of GraphStudio expires on December 31, 2023. Please see xref:graphstudio:graphstudio-zoomchart-update.adoc[] for more details.
