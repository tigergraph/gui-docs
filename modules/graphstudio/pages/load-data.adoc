...
See the page on xref:graphstudio:data-transformation.adoc[Data Transformation] for information about making changes to the data during the loading process.
...
=== Graph Statistics
If you click on any vertex, graph statistics are displayed.

image::graph_stat.png[]
...
If you click the refresh icon on the top right, it refetches real-time graph statistics.

=== Data Loading Statistics
If you click on one data file, Data Loading Statistics are displayed.
