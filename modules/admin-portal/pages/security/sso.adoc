...
+
image::self-sign-new.png[]

[NOTE]
====
In 4.2.3, SAML SSO supports uploading a full X.509 certificate chain for the Service Provider (SP).
...
[NOTE]
====
In 4.2.3, SAML SSO supports uploading a full X.509 certificate chain for the Identity Provider (IdP).
