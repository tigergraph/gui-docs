...
Consult the xref:{page-component-version}@tigergraph-server:user-access:sso.adoc[SSO] page on the TigerGraph Server documentation to read more about the supported SSO methods and the configurations required.
