...
. xref:{page-component-version}@tigergraph-server:user-access:enabling-user-authentication.adoc[GSQL authentication must be enabled] by changing the password of the GSQL default user.
