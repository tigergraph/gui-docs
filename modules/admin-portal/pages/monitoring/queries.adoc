...
In 4.1.4, access to the Query Monitoring page is controlled by user privileges instead of roles.
...
If a user does not have `READ_DATA` privilege on any graph, the page displays an error message indicating that the user does not have access and should contact the administrator.
