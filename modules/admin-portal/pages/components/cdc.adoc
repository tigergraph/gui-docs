...
For more details see xref:{page-component-version}@tigergraph-server:system-management:change-data-capture/cdc-overview.adoc[].
...
For more details on CDC configurations see xref:{page-component-version}@tigergraph-server:system-management:change-data-capture/cdc-setup.adoc#_cdc_configuration_parameters[Configuration Parameters].
