...
image::gsql-output-file-initial.png-new[GSQL output file page]
...
Make sure the provided file path is allowed by the xref:{page-component-version}@tigergraph-server:security:file-output-policy.adoc[GSQL file output policy].
...
image::file-in-preview.png-new[File in preview]
