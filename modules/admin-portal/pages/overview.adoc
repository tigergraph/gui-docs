...
image::admin-user-menu-4.1.png[]
//image::admin-user-menu-new.png[]
//image::admin-user-menu-updated.png[]

From the user menu, you can change the user language and access additional user options.

To sign out of Admin Portal, click on the *Log out* button in the user menu.
